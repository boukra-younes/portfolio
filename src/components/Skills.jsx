...
const Skills = () => {
  ...
  const skillCategories = [
    ...
    },
    {
      title: "Backend",
      skills: [
        { name: "Django", level: 60, color: "bg-green-950" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Illustrator", level: 85, color: "bg-orange-400" },
      ],
    },
  ];
    ...
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            A comprehensive toolkit built through years of learning and hands-on
            experience
          </p>
        </div>
